...
trigger Field_Observation_123Trigger on Field_Observation__c (before insert,after insert,before update,after update,before delete,after delete,after undelete){
